ActiveAdmin.register_page "Retention Explorer" do
  ...
  content title: proc { I18n.t("active_admin.retention_explorer") } do
    ...
    render(partial: "show", locals: {
      ...
      admin_users_sorted_by_tenure_in_days: admin_users_sorted_by_tenure_in_days.reject{|a| a[:considered_temporary]},
      admin_users_considered_temporary: admin_users_sorted_by_tenure_in_days.select{|a| a[:considered_temporary]}
    })
  end
end
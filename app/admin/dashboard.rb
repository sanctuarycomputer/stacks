ActiveAdmin.register_page "Dashboard" do
  ...
  content title: proc { I18n.t("active_admin.dashboard") } do
    locals = Rails.cache.fetch("active_admin.dashboard#locals", expires_in: 24.hours) do
...

      {
        ...
        data_integrity_problem_count: Stacks::DataIntegrityManager.new.problem_count
      }
    end

    render(partial: "dashboard", locals: locals)
  end
end
